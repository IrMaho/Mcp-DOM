...
export class DisappearingElementAnalyzer {
    static analyze(targetQuery, events, initialSnapshot) {
        ...
        let disappearedAt = trace.removedAt ?? undefined;
        ...
        const classHiddenEntry = trace.entries.find((e) => e.stage === 'CLASS_MODIFIED' &&
            /\b(hidden|hide|d-none|invisible|collapsed)\b/i.test(String(e.details.newValue || '')));
        const styleHiddenEntry = trace.entries.find((e) => e.stage === 'STYLE_MODIFIED' &&
...
//# sourceMappingURL=disappearing-analyzer.js.map