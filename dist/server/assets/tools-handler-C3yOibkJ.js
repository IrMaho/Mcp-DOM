  ...
  async dispatchAction(element, payload) {
    ...
    switch (payload.action) {
      ...
      case "type": {
        ...
        for (const char of text) {
          const createKeyEvt = (evtType) => {
            try {
              return new KeyboardEvent(evtType, { key: char, bubbles: true });
            } catch {
              return new CustomEvent(evtType, { bubbles: true, detail: { key: char } });
            }
          };
          const createInputEvt = (evtType, opts) => {
            try {
              if (typeof InputEvent !== "undefined") return new InputEvent(evtType, opts);
              if (typeof window !== "undefined" && window.InputEvent) return new window.InputEvent(evtType, opts);
            } catch {
            }
            return new CustomEvent(evtType, { bubbles: true, detail: opts });
          };
      ...
      case "press_key": {
        ...
        const createKeyEvt = (evtType) => {
          try {
            return new KeyboardEvent(evtType, { key, bubbles: true });
          } catch {
            return new CustomEvent(evtType, { bubbles: true, detail: { key } });
          }
        };
        element.dispatchEvent(createKeyEvt("keydown"));
        element.dispatchEvent(createKeyEvt("keypress"));
